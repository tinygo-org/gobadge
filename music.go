...
func Music() {
	...
	tinyfont.WriteLine(&display, &fonts.Bold24pt7b, 0, 50, []byte("MUSIC"), color.RGBA{0, 100, 250, 255})
	tinyfont.WriteLine(&display, &fonts.Bold9pt7b, 20, 100, []byte("Press any key"), color.RGBA{200, 0, 0, 255})
